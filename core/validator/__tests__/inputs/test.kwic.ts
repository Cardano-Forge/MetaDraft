...
Deno.test("TestKwic", () => {
  ...
  assertEquals(result["KWIC4479"].warnings[0].validationError.length, 9);
  assertEquals(result["KWIC4479"].warnings[0].validationError[0].path, [
    "Body",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[1].path, [
    "Head",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[2].path, [
    "Side",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[3].path, [
    "Bling",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[4].path, [
    "Faction",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[5].path, [
    "Background",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[6].path, [
    "Foreground",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[7].path, [
    "Back Attachment",
  ]);
  assertEquals(result["KWIC4479"].warnings[0].validationError[8].path, [
    "Head Attachment",
  ]);
  ...
  assertEquals(
    result["KWIC4479"].warnings[1].validationError[0].message,
  ...
  assertEquals(result["KWIC4479"].warnings[2].validationError[0].path, [
    "Back Attachment",
  ]);
  assertEquals(result["KWIC4479"].warnings[2].validationError[1].path, [
    "Head Attachment",
  ]);
});
